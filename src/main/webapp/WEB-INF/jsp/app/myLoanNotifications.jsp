				...
				<div class="loans">
					<ul class="pure-g">
						<c:forEach var="loan" items="${loans}">
							...
							<li id="loan-${loan.id}" class="glowing-border clear-bt pos-li pure-u-1-2" style="background-color:${backgroundColor}">	
								<div class="loan">
									<div class="info">
										<span class="holder pure-g">
											<img height="130" width="100" src='<c:url value="/app/image/${loan.product.id}" />' />
											<span class="pure-u-1-1 book-name">
												${loan.product.title}
											</span><br />
